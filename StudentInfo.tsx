...
export function StudentInfo({ onStart }: StudentInfoProps) {
          ...
          <form onSubmit={handleAcademicSubmit} className="space-y-8">
            ...
            <div className="flex justify-between pt-6 border-t">
              <button
                type="button"
                onClick={prevStep}
                className="px-6 py-3 border border-gray-300 rounded-lg text-gray-600 font-medium hover:bg-gray-50"
              >
                Previous
              </button>
              <button
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Tell us about your interests and achievements</p>
            <div className="mt-2 text-sm text-orange-600 font-medium">
              Step 3 of 7: Extracurricular Activities
            </div>
          </div>
          ...
          <form onSubmit={handleExtracurricularSubmit} className="space-y-6">
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition"
                placeholder="Physical games, teamwork, fitness activities..."
                rows={3}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition"
                placeholder="Volunteering, organizing, social impact projects..."
                rows={3}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition"
                placeholder="Music, dance, drama, creativity activities..."
                rows={3}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                value={state.extracurricular.academic}
                onChange={(e) => updateNestedState('extracurricular', 'academic', e.target.value)}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition"
                placeholder="Quizzes, research, academic excellence..."
                rows={3}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                value={state.extracurricular.technology}
                onChange={(e) => updateNestedState('extracurricular', 'technology', e.target.value)}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition"
                placeholder="Coding, robotics, design thinking projects..."
                rows={3}
              />
            </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Select your preferred career/study areas</p>
            <div className="mt-2 text-sm text-orange-600 font-medium">
              Step 4 of 7: Career Interests
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="aiMl"
                  checked={state.interests.aiMlDataScience}
                  onChange={(e) => updateNestedState('interests', 'aiMlDataScience', e.target.checked)}
                  className="h-5 w-5 text-orange-600 rounded focus:ring-orange-500"
                />
                <label htmlFor="aiMl" className="ml-3 text-gray-700 font-medium">
                  AI/ML & Data Science
                </label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="energy"
                  checked={state.interests.energySustainability}
                  onChange={(e) => updateNestedState('interests', 'energySustainability', e.target.checked)}
                  className="h-5 w-5 text-orange-600 rounded focus:ring-orange-500"
                />
                <label htmlFor="energy" className="ml-3 text-gray-700 font-medium">
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="emobility"
                  checked={state.interests.emobilityIot}
                  onChange={(e) => updateNestedState('interests', 'emobilityIot', e.target.checked)}
                  className="h-5 w-5 text-orange-600 rounded focus:ring-orange-500"
                />
                <label htmlFor="emobility" className="ml-3 text-gray-700 font-medium">
                  eMobility & IoT
                </label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="lifeSciences"
                  checked={state.interests.lifeSciencesHealthcare}
                  onChange={(e) => updateNestedState('interests', 'lifeSciencesHealthcare', e.target.checked)}
                  className="h-5 w-5 text-orange-600 rounded focus:ring-orange-500"
                />
                <label htmlFor="lifeSciences" className="ml-3 text-gray-700 font-medium">
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="business"
                  checked={state.interests.businessEntrepreneurship}
                  onChange={(e) => updateNestedState('interests', 'businessEntrepreneurship', e.target.checked)}
                  className="h-5 w-5 text-orange-600 rounded focus:ring-orange-500"
                />
                <label htmlFor="business" className="ml-3 text-gray-700 font-medium">
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <div className="text-center mb-8">
            ...
            <div className="mt-2 text-sm text-orange-600 font-medium">
              Step 5 of 7: Review & Declaration
            </div>
          </div>
          ...
          <form onSubmit={handleReviewSubmit} className="space-y-8">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">{state.name || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Email</p>
                  <p className="font-medium">{state.email || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Phone</p>
                  <p className="font-medium">{state.phone || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Date of Birth</p>
                  <p className="font-medium">{state.dateOfBirth || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Institution</p>
                  <p className="font-medium">{state.institution || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Board of Study</p>
                  <p className="font-medium">{state.boardOfStudy || 'Not provided'}</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2">
                    {Object.entries(state.tenthGrade).map(([subject, marks]) => (
                      <div key={subject} className="flex justify-between">
                        <span className="text-sm text-gray-600 capitalize">{subject}</span>
                        <span className="font-medium">{marks || 'Not provided'}</span>
                      </div>
                    ))}
                  </div>
                </div>
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">11th Grade</h4>
                  <div className="space-y-2">
                    {Object.entries(state.eleventhGrade).map(([subject, marks]) => (
                      <div key={subject} className="flex justify-between">
                        <span className="text-sm text-gray-600 capitalize">{subject}</span>
                        <span className="font-medium">{marks || 'Not provided'}</span>
                      </div>
              ...
              <div className="mb-6">
                <div className="flex items-start">
                  <input
                    ...
                    className="h-5 w-5 text-orange-600 rounded focus:ring-orange-500 mt-1"
                    required
                  />
                  <label htmlFor="terms" className="ml-3 text-gray-700">
                    I hereby declare that the above information is true to the best of my knowledge. 
                    I permit Atria University to store this information and agree to take the 
                    scholastic aptitude test administered by Atria University.
                  </label>
                </div>
              </div>
            ...
            <div className="flex justify-between pt-6 border-t">
              ...
              <button
                type="submit"
                disabled={!state.termsAccepted || !state.signature.trim()}
  ...
  // Step 6: OTP Verification (keep existing OTP UI)
  if (state.step === 'otp') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-md w-full">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Verify Mobile Number</h1>
          ...
          <form onSubmit={handleOtpSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full text-center text-2xl tracking-widest px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition"
                placeholder="000000"
                maxLength={6}
                required
              />
              <div className="flex justify-between items-center mt-2">
                {state.countdown > 0 ? (
                  <span className="text-sm text-gray-500">
                    Resend OTP in {formatCountdown(state.countdown)}
                  </span>
                ) : (
                  <button
                    type="button"
                ...
                <button
                  type="button"
                  onClick={() => setState(prev => ({ ...prev, step: 'info' }))}
          ...
          <div className="mt-6 p-4 bg-orange-50 rounded-lg">
            <p className="text-sm text-gray-700">
              <strong>Note:</strong> OTP is valid for 2 minutes. For demo purposes, the OTP is displayed in an alert.
            </p>
          </div>
        </div>
      </div>
  ...
  // Step 7: Location Capture (keep existing location UI)
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Location Access</h1>
          <p className="text-gray-600">Final step: Location verification for personalized experience</p>
          <div className="mt-2 text-sm text-orange-600 font-medium">
            Step 7 of 7: Location Verification
          </div>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="relative">
              ...
              {state.isLoadingLocation && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="animate-spin rounded-full h-28 w-28 border-b-2 border-orange-600"></div>
                </div>
              )}
            </div>
          </div>
          ...
          {state.location ? (
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-green-700 text-center">
                <strong>Location captured successfully!</strong><br/>
                {state.location.address && (
                  <span className="text-sm">{state.location.address}</span>
                )}
              </p>
            </div>
          ) : (
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-yellow-700 text-center">
                {state.isLoadingLocation ? 'Getting your location...' : 'Waiting for location access...'}
              </p>
            </div>
          )}

          <form onSubmit={handleLocationSubmit} className="space-y-4">
            {!state.isLoadingLocation && !state.location && (
              <button
                type="button"
                onClick={handleGetLocation}
                className="w-full bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 rounded-lg transition duration-200 shadow-md hover:shadow-lg"
              >
            ...
            <button
              type="submit"
              disabled={!state.location && !state.isLoadingLocation}
            ...
            >
              {state.location ? 'Complete Application' : 'Please allow location to continue'}
            </button>
          ...
          <div className="mt-6 p-4 bg-orange-50 rounded-lg">
            <p className="text-sm text-gray-700">
              <strong>Why we need location:</strong> Helps us provide region-specific insights and opportunities.
            </p>
          </div>
        </div>
      </div>
