    ...
    const fetchProfileData = async () => {
        try {
            ...
            if (token) {
                ...
                try {
                    const locRes = await fetch(`${import.meta.env.VITE_API_URL || ''}/auth/my-location`, {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#3B4DC9] mx-auto mb-4"></div>
                ...
                <div className="max-w-4xl mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            />
                            <h1 className="text-xl font-bold text-slate-900 hidden sm:inline">My Profile</h1>
                        </div>
                        ...
                        {!editing ? (
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-[#3B4DC9] text-white rounded-lg hover:bg-[#2E3DA1] transition shadow-md"
                            >
                                <Edit3 size={18} />
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    disabled={saving}
                                    className="flex items-center gap-2 px-4 py-2 bg-[#00C853] text-white rounded-lg hover:bg-[#00B548] transition disabled:opacity-50 shadow-md"
                                >
                                    <Save size={18} />
                                    {saving ? 'Saving...' : 'Save'}
                                </button>
